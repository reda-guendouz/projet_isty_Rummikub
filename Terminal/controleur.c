...
int main(void)
{
    ...
    int jouer, nbJoueursH, choixJoueur, joueurActuel, numTuileChoisis, choixPlacement, choixModifPlateau,
        colonneSource, colonneDestination, selection = 0, nbJoueurs = 4;
    char ligneSource, ligneDestination;
    int estSelectionne[50], premiereMain[nbJoueurs];
    ;
                            ...
                            else if (choixModifPlateau == 4)
                            {
                                do
                                {
                                    ...
                                    else
                                    {
                                        system("clear");
                                        affiche_plateau(copiePlateau[0]);
                                        printf("Voulez-vous continuer la modification du plateau?\n");
                                        printf("0. Non\n");
                                        printf("1. Oui\n");
